...
const About = () => {
    return (
        <div className={ styles.Page }>
            ...
            <p className={ styles.Content }>My name is Niklas Solomon. I am 29 years old. I was born in Utah and lived there most of my life. I moved to the Seattle area in the Spring of 2021 thanks to an opportunity to relocate through my company at the time. Since then, I have established myself and decided to pursue a career in web and software development.<br/>
